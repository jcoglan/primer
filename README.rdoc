...
This is an experiment to bring automatic cache expiry and regeneration to
Rails. At Songkick[http://www.songkick.com], we have a ton of code that deals
...
use real-time updates and where the messaging server is:
...
Copyright (c) 2010 Songkick.com. Named by the inimitable
grillpanda[http://github.com/grillpanda].
